...
public class Export {
    ...
    private int id, pro_id, cli_id, num_of_con, pallet_numb, ord_id, storageID;
    private double tot_wight, weight, empty_pack;
    private String lot;
    private boolean used;
    private Date inserted_date, exported_date;

    public Export(int id, int pro_id, int cli_id, int ord_id, int num_of_con, int pallet_numb, double tot_wight, double weight, String lot, boolean used, Date inserted_date, Date exported_date, double empty_pack, int storageID) {
        this.id = id;
        this.pro_id = pro_id;
        this.cli_id = cli_id;
        this.ord_id = ord_id;
